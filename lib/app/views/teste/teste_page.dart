...
hasLargeIcon: ${evt.hasLargeIcon}
id: ${evt.id}
key: ${evt.key}
largeIcon: ${evt.largeIcon}
message: ${evt.message}
  ...
  void startListening() async {
    ...
    if (!isRunning) {
      await NotificationsListener.startService(
          foreground: false, title: "Listener Running", description: "Welcome to having me");
    }
                                  ...
                                  onPressed: () {
                                    ...
                                    if (act.semantic == 1) {
                                      ...
                                      (act.inputs ?? []).forEach((e) {
                                        ...
                                        map[e.resultKey ?? 'null'] = "Auto reply from me";
                                      });
                                      act.postInputs(map);
                                    } else {
                                      // just tap
